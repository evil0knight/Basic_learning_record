...
| RTT  | J-Link 终端 | 极快（SRAM直写） | J-Link 调试器       | [RTT printf配置](../debug方法/RTT/使用.md)                                    |
...
详见 [RTT使用](../debug方法/RTT/使用.md)

---

> 💡 需要格式输出（彩色分级、日志过滤、按标签存储）看 [EasyLogger](../debug方法/EasyLogger.md)，使用教程将在此更新。
